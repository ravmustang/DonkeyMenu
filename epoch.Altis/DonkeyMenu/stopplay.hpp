...
class stop_playing_possum {
	...
	class controls 
	{
		class IGUIBack_2204: DP_PP_IGUIBack
		{
			idc = 2204;
		...
		class RscButton_1644: DP_PP_RscButton
		{
			idc = 1644;
			text = "STOP PLAYING!";
			...
			colorText[] = {0,1,0,1};
			tooltip = "";
			action = "closeDialog 0;[] call dp_Possum_Stop";
		};
		class RscText_1022: DP_PP_RscText
		{
			idc = 1022;
			text = "You Sneaky Little Bastard";
