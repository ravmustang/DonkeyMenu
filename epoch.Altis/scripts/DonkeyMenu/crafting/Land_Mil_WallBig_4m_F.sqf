...
// Item to place
_ItemsClassName							= "Land_Mil_WallBig_4m_F";	// Classname of the item to place
_ItemDisplayName						= "Military Wall";				// Item name to display in the player menu

// Materials Required to Create Lights
_EnergyRequired							= 1000;						// Amount of energy expended to build (0 for zero energy required)
_MaterialRequired1						= "ItemCorrugated";				// First material required to build (default is 'CircuitParts' or Electronic Component)
_MaterialRequired1Count					= 2;
_MaterialRequired2						= "ItemCorrugatedLg";			// Second material required to build (default is 'ItemCorrugated' or small metal parts)
