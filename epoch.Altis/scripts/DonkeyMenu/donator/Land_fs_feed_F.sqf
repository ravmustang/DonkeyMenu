...
// Item to place
_ItemsClassName							= "Land_fs_feed_F";	// Classname of the item to place
_ItemDisplayName						= "Fuel Pump";				// Item name to display in the player menu

// Materials Required to Create Lights
_EnergyRequired							= 2500;						// Amount of energy expended to build (0 for zero energy required)
