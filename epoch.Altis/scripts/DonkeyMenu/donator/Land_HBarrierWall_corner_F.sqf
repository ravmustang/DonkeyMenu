...
// Item to place
_ItemsClassName							= "Land_HBarrierWall_corner_F";	// Classname of the item to place
_ItemDisplayName						= "H-Barrier Corner";				// Item name to display in the player menu

// Materials Required to Create Lights
_EnergyRequired							= 750;						// Amount of energy expended to build (0 for zero energy required)
