...
// Item to place
_ItemsClassName							= "Land_LampHalogen_F";	// Classname of the item to place
_ItemDisplayName						= "Halogen Lamp";				// Item name to display in the player menu

// Materials Required to Create Lights
_EnergyRequired							= 600;						// Amount of energy expended to build (0 for zero energy required)
