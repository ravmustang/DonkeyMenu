...
{	
	...
	class controls
	{
		class IGUIBack_2200: DMdon_IGUIBack
		{
			idc = -1;
		...
		class RscFrame_1800: DMdon_RscFrame
		{
			idc = -1;
		...
		class RscButton_1601: DMdon_RscButton
		{
			idc = 1601;
		...
		class RscButton_1603: DMdon_RscButton
		{
			idc = 1603;
		...
		class RscButton_1604: DMdon_RscButton
		{
			idc = 1604;
		...
		class RscButton_1605: DMdon_RscButton
		{
			idc = 1605;
		...
		class RscButton_1606: DMdon_RscButton
		{
			idc = 1606;
		...
		class RscButton_1607: DMdon_RscButton
		{
			idc = 1607;
		...
		class RscText_1000: DMdon_RscText
		{
			idc = 1000;
			text = "Donkey Menu Donator Panel"; //--- ToDo: Localize;
		...
		class RscButton_1609: DMdon_RscButton
		{
			idc = 1609;
			text = "Survivor Hunt"; //--- ToDo: Localize;
			x = 0.613437 * safezoneW + safezoneX;
			y = 0.39 * safezoneH + safezoneY;
			w = 0.0670312 * safezoneW;
			h = 0.055 * safezoneH;
			colorText[] = {1,1,0,1};
			tooltip = "Survivor Hunt! PvP Player Initiated Mission";
			action = "closeDialog 0;[] call dp_SurvivorHunt";
		};
		class RscButton_1610: DMdon_RscButton
		{
			idc = 1610;
