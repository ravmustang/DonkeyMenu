...
if(_groupExists) then
{
    ...
    hint parseText format["<t size='1.20' font='PuristaMedium' color='#0CE800'>[GROUP]</t><br/>
        <t size='1' font='PuristaMedium' align='left'>You have joined %1's group!</t><br/>", name _inviter];
} else {
    hint parseText format["<t size='1.20' font='PuristaMedium' color='#0CE800'>[GROUP]</t><br/>
        <t size='1' font='PuristaMedium' align='left'>Sorry, %1 disbanded the group!</t><br/>", name _inviter];
}; 